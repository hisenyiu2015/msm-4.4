...
{
	ab_pci->msi_config = &ath11k_msi_config;
...
/* FIXME: use __always_unused to shut up a warning as pci.c is
 * work-in-progress at the moment. Remove it once we start really using
 * these ops!
 */
static const __always_unused struct ath11k_hif_ops ath11k_pci_hif_ops = {
			    ...
			    const struct pci_device_id *pci_dev)
{
	...
	ath11k_warn(ab, "PCI support is work-in-progress, this won't work yet!\n");
